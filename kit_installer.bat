...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/angry-birds-python/releases/download/v1.0.0/angry-birds-python-main.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/angry-birds-python/raw/main/requirements.txt
SET REPO_NAME=AngryBird.zip
SET EXTRACTED_REPO_DIR=angry-birds-python-main
